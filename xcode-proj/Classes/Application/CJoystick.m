...
-(void)draw
{
	...
	if ((flags&JFLAG_JOYSTICK)!=0)
	{		
		[renderer renderImage:(ITexture*)joyBackTex withX:imagesX[KEY_JOYSTICK]-(joyBackTex->width/2)*zoom andY:imagesY[KEY_JOYSTICK]-(joyBackTex->height/2)*zoom  andWidth:joyBackTex->width*zoom  andHeight:joyBackTex->height*zoom andInkEffect:0 andInkEffectParam:0];
		[renderer renderImage:(ITexture*)joyFrontTex withX:imagesX[KEY_JOYSTICK]+joystickX-(joyFrontTex->width/2)*zoom andY:imagesY[KEY_JOYSTICK]+joystickY-(joyFrontTex->height/2)*zoom andWidth:joyFrontTex->width*zoom andHeight:joyFrontTex->height*zoom andInkEffect:0 andInkEffectParam:0];
	}
	if ((flags&JFLAG_FIRE1)!=0)
	{
		CImage* tex = ((joystick&0x10)==0) ? fire1UTex : fire1DTex;
		[renderer renderImage:(ITexture*)tex withX:imagesX[KEY_FIRE1]-(tex->width/2)*zoom andY:imagesY[KEY_FIRE1]-(tex->height/2)*zoom andWidth:tex->width*zoom andHeight:tex->height*zoom andInkEffect:0 andInkEffectParam:0];
	}
	if ((flags&JFLAG_FIRE2)!=0)
	{
		CImage* tex = ((joystick&0x20)==0) ? fire2UTex : fire2DTex;
		[renderer renderImage:(ITexture*)tex withX:imagesX[KEY_FIRE2]-(tex->width/2)*zoom andY:imagesY[KEY_FIRE2]-(tex->height/2)*zoom andWidth:tex->width*zoom andHeight:tex->height*zoom andInkEffect:0 andInkEffectParam:0];
	}
}
